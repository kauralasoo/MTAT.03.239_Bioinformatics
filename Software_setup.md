...
[Snakemake](http://snakemake.readthedocs.io/en/latest/) is a tool to define and execute reproducible bioinformatics workflows. It greatly simplifies running 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzYyODUyMTk5XX0=
-->