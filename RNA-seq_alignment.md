...
By default, HISAT2 outputs results as uncompressed SAM to the standard output. Since these files can be very large, it makes sense to convert them direct 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjY0OTE1MDNdfQ==
-->