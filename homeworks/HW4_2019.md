...
1. Using the code example provided [here](https://github.com/kauralasoo/MTAT.03.239_Bioinformatics/blob/master/QTL_analysis/simulating_genetic_associations.md), estimate the sample size required to reject the null hypothesis (p < 0.05) that genotype has now effect on gene expression when 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4NzMzMDg4LDE5MDY4NTQ3OThdfQ==
-->