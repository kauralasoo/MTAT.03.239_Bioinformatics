...
2. Modify the the simulation so that the minor allele frequency is still 0.5, but the genotype now explains only 10% of the total variance. How much larger has the sample size 
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQwNDU0NTE0LDIwMDc5MTA3NDgsMTkwNj
g1NDc5OF19
-->