...
Repeat the colocalisation analysis with the priors that you used in Task 2 but now instead of using the +/- 200kb region around the lead eQTL variant, try three progressively smaller regions (+/- 100kb, +/- 50kb and +/- 5kb). How do the colocalresults change for the three loci (PTK2B, TRAF1 and ICOSLG)? 



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTAyMTc4NzMsLTg3NjE0MTA3NiwyMD
