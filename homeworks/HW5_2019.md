...
Since the gene expression and protein expression were measured form the same individuals, you can also assess the correllation between CD14 gene and protein expression (in naive condition only). Do these resumake a scatter plot of the two to assess how well is gene expression correlated with protein expression. 


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDY5Mzc1MDEsMTg3Mzg2NjM3NCw2Mz
E5Mzc5NTVdfQ==
-->