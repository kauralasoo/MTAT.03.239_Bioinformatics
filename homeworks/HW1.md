...
**Learning objective:** In Task 2, you learned how to measure gene expression (count the number of RNA-seq reads overlapping a gene) in one sample. You saw, that this process involved multiple steps - alignment, sorting, indexing and counting. This a typical of many bioinformatics workflows where you have to run tens of data processing steps on hundreds 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzODg1NjQwMF19
-->