...
**Learning objective:** In Task 2, you learned how to measure gene expression (count the number of RNA-seq reads overlapping a gene)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTUyMDg3MjhdfQ==
-->