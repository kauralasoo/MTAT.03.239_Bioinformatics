...
**Learning objective:** Understand what the raw RNA sequencing reads (in FASTQ format)  look like, how you can use alignment software (HISAT2) to find the locations in the reference genome where these reads come from. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwNTM5Njk0XX0=
-->