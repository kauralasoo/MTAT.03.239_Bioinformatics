...
Using the [RNA-seq alignment tutorial](https://github.com/kauralasoo/MTAT.03.239_Bioinformatics/blob/master/RNA-seq_alignment.md), answer the following questions:
 ...
 6. Find the number of paired-end fragments overlapping the the PFKL and AIRE genes from the featureCounts file. Do these match to what you observed in IGV? (HINT: You can use the search box on Ensembl website to find the gene ids for 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNjA1NDYzN119
-->