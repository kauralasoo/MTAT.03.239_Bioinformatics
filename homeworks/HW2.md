...
# Bonus tasks 1 (deadline 16 March 2018 @ 11:59PM) 
 ...
 1. How many principal components of the [full gene expression dataset](https://www.dropbox.com/s/j52l5kdrxpaho30/RNA_SummarizedExperiment.rds) (336 samples) can you 'explain' by the known sample metadata? You can find view the sample metadata using the colData() function of the SummarizedExperiment class.  (2 point)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2Mzc4MTAyOV19
-->