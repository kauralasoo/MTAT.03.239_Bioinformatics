...
One way to quantify linkage disequilibrium between two genetic variants is to calculate the square of the Pearson's correlation coefficient (r<sup>2</sup>). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwMDUwMzEyNV19
-->