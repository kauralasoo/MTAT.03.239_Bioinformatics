...
One way to quantify linkage disequilibrium (LD) between two genetic variants is to calculate the square of the Pearson's correlation coefficient (r<sup>2</sup>). High LD between genetic variants means that
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYwMDcwNTg4XX0=
-->