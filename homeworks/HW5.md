...
One way to quantify linkage disequilibrium between two genetic variants is to calculate the square of the Pearson's correllation coe 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc3MTQxODU3XX0=
-->