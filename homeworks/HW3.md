...
**Learning objective:** Understand how differential transcript usage manifest at the level of RNA-seq read coverage and how these changes can be detected using visual inspection.
 ...
 4. Make screenshots of RNA-seq read coverage from these three genes and include them in your report. Also, highlight the specific exons or parts of trans




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNDQ1NTkzMzJdfQ==
-->